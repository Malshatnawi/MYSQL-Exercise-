...
if(!$connection){
    ...
    $image_name=$_FILES['category_edit_picture']['name'];
    $tmp_name   = $_FILES['category_edit_picture']['tmp_name'];
    $path       = 'images/categories_images/';

    move_uploaded_file($tmp_name,$path.$image_name);

    $cat_name=$_POST['category_edit_name'];


    // $query = "insert into categories(NAME, Image) values('$cat_name','$path.$image_name')";


    // $query = "update categories set Name    = '$cat_name',
    //                            Image       = '$path.$image_name',
    //           where ID = {$_GET['id']}";

    $query = "UPDATE categories
                SET Name = '$cat_name', Image= '$path.$image_name'
                WHERE ID = {$_GET['id']}";
                                    ...
                                    <div class="card-body card-block">
                                        ...
                                        <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="category_edit_name" placeholder="Category Name" class="form-control" value="<?php echo $row['Name'] ?>">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="file-input" name="category_edit_picture" class="form-control-file" value="<?php $row['Image']  ?>">
                                                </div>
                                            </div>
                                            <div class="card-footer">
                                                <button type="submit" class="btn btn-primary btn-sm" name="category_edit_submit">
                            ...
                            <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <!-- <?php
                                            ...
                                            //      // echo "<td><a href='deleteusers.php'>Delete</td>";
