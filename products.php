...
if(isset($_POST['product_submit'])){
    ...
    $query="INSERT INTO products (Name, Image, Product_Price, Cat_Id, Special_Price)
    VALUES ('$product_name', '$path.$image_name', '$product_price', '$category_id', '$special_price');";
                                    ...
                                    <div class="card-body card-block">
                                        <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="category_id" placeholder="Category ID" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="product_price" placeholder="Product Price" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="text-input" name="special_price" placeholder="Special Price" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="file" id="file-input" name="product_img" class="form-control-file">
                                                </div>
                                            </div>
                                            ...
                                            <?php
                                                ...
                                                if(mysqli_num_rows($result) > 0){
                                                    ...
                                                    while($rows=mysqli_fetch_assoc($result)){
                                                        ...
                                                        echo "<td><img src='{$rows['Image']}' width='200' height='150'></td>";
                                                        echo "<td>".$rows['Product_Price']."</td>";
                                                        echo "<td>".$rows['Cat_Id']."</td>";
                                                        echo "<td>".$rows['Special_Price']."</td>";
                                                        echo "<td><a href='edit_products.php?id={$rows['ID']}' <button class='btn btn-primary'>Edit</button></a></td>";
                                                        echo "<td><a href='delete.php?id={$rows['ID']}' <button class='btn btn-danger'>Delete</button></a></td>";
                                                        echo "</tr>";
